...
func (x *Success) GetObjectId() string {
	if x != nil {
		return x.ObjectId
	}
	return ""
...
func (x *Failure) Reset() {
	*x = Failure{}
	if protoimpl.UnsafeEnabled {
		mi := &file_constants_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Failure) GetDetails() string {
	if x != nil {
		return x.Details
	}
	return ""
...
var file_constants_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x0a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x22, 0x40, 0x0a,
	0x07, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69,
	0x6c, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22,
	0x23, 0x0a, 0x07, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x65,
...
var file_constants_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_constants_proto_goTypes = []interface{}{
	(*Success)(nil), // 0: protofiles.Success
	(*Failure)(nil), // 1: protofiles.Failure
}
...
func file_constants_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_constants_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
